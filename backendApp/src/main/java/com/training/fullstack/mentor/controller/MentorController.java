...
public class MentorController {
    ...
    @PostMapping("/findByTimeAndTechnology")
    public ResponseEntity<List<MentorRepresentation>> searchByTimeAndTechnology
            (@RequestBody SearchMentorRepresentation searchMentorRepresentation) {
        List<Mentor> foundMentor = mentorService.searchMentorByTimeAndTechnologyAndDate(
                searchMentorRepresentation.skillId,
                searchMentorRepresentation.desiredDate,
                searchMentorRepresentation.fromTime,
                searchMentorRepresentation.toTime);
    ...
    @GetMapping("/{id}")
    public ResponseEntity<MentorRepresentation> getMentor (@PathVariable Long id) {
        Mentor foundMentor = mentorService.get(id);
        return ok(MentorRepresentation.fromMentor(foundMentor));
    }
